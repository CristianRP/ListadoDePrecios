    ...
    constructor(props, context) {
        ...
        this.state = {
            ...
            collapse: {
                ...
                tables: this.routeActive(['table-standard', 'table-extended', 'table-datatable', 'table-jqgrid', 'table-listadoprecios']),
                            ...
                            <li className={ this.routeActive(['table-standard', 'table-extended', 'table-datatable', 'table-jqgrid']) ? 'active' : '' }>
                                ...
                                <Collapse in={ this.state.collapse.tables }>
                                    <ul id="" className="nav sidebar-subnav">
                                        ...
                                        <li className={ this.routeActive('table-listadoprecios') ? 'active' : '' }>
                                            <Link to="table-listadoprecios" title="ListadoPrecios">
